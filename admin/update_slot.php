...
$ambil=mysql_query("select * from maklumat_slot where id='$name'");
	...
	echo "<h2 class='head'>Kemaskini Maklumat Slot $_GET[id2] </h2> 
...
<tr>
	<td>Pengacara</td><td>:</td><td> <select name='penceramah' class='form-control1' >
	...
	<tr>
	  ...
	  <td>Maklumat</td>
						   <td> : </td><td><textarea name='sinopsis' cols='50' rows='5'> $t[sinopsis]</textarea></td>
