			...
			if($_POST['submit']){
				...
				if(in_array($file_ext, $allowed_ext) === true){
					if($file_size < 5044070){
						...
						$structure = '../Infiru Files/invoice/';
						
						move_uploaded_file($file_tmp, $lokasi);
						$in = mysql_query("INSERT INTO upload_invois VALUES(NULL , '$slot','$tgl','$nama', '$file_ext', '$file_size', '$lokasi','$lokasi2')");
						if($in){
...
<h2 class='head'><span class="glyphicon glyphicon-file"></span> Invois</h2>
...
<form action="" method="post" enctype="multipart/form-data">
 ...
 <?php $nama=$_GET["id"] ; ?>
    ...
    <input type="text" name="nama"  class="form-control1" value="Invoice Slot <?php echo $_GET['id'];  ?>" required />
    
      <input name="nama_slot" type="hidden" value="<?php echo $nama;  ?>">
